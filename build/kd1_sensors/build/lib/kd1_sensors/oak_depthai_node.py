...
class OakDepthAINode(Node):
    def __init__(self):
        ...
        self.roiWidthStart = 230
        self.roiWidthEnd = self.width - 230
        self.roiHeightStart = 50 # 50 from top
        self.roiHeightEnd = 280 # 330 from bottom
        
        ### CRITICAL DISTANCE IN CM ###
        self.distance_threshold = 38.0 

        # decision buffering
        self.decision_buffer = collections.deque(maxlen=5)
        self.stable_count = 0  
        self.stable_threshold = 1 # CHANGE FOR FASTER RESULT
