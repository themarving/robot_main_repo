...
class LightRingNode(Node): 
    def __init__(self):
        ...
        self.anim_1 = self.animation_one()
        self.anim_2 = self.animation_two()
        self.anim_3 = self.animation_three()
        self.anim_4 = self.animation_four()
        ...
        self.kd1_is_obstructed = True
        
        # obstruction light animation
        self.create_timer(0.5, self.check_for_obstruction)
    ...
    def check_for_obstruction(self):
        if self.kd1_is_obstructed:
            pixel_ring.customize(self.anim_1) 
            ...
            pixel_ring.customize(self.anim_2) 
            pixel_ring.set_brightness(10)   
            ...
            pixel_ring.customize(self.anim_3) 
            pixel_ring.set_brightness(10)   
            ...
            pixel_ring.customize(self.anim_4) 
            pixel_ring.set_brightness(10)   
    ...
    def process_command(self, msg):
        if msg.data == "path_obstructed":
            self.kd1_is_obstructed = True
            
        elif msg.data == "obstruction_cleared":
            self.kd1_is_obstructed = False
            
        elif msg.data == "flash_light_ring":
