...
#include "custom_interfaces/msg/detail/imu_data__rosidl_typesupport_fastrtps_c.h"
...
using _IMUData__ros_msg_type = custom_interfaces__msg__IMUData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: gyroscope_x
  {
    cdr << ros_message->gyroscope_x;
  }

  // Field name: gyroscope_y
  {
    cdr << ros_message->gyroscope_y;
  }

  // Field name: gyroscope_z
  {
...
size_t get_serialized_size_custom_interfaces__msg__IMUData(
  const void * untyped_ros_message,
...
static uint32_t _IMUData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__IMUData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__IMUData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__IMUData;
    is_plain =
      (
...
static size_t _IMUData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__IMUData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, IMUData)() {
